...
import { Photo, Album } from "@lounge/types"; // Assuming Album might be needed for context like album name
import DraggableList from "../../../components/admin/DraggableList";
import PhotoListItem from "../../../components/admin/PhotoListItem"; // Assuming you have or will create this
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <DraggableList
            ...
            renderItem={(item, index) => (
              <PhotoListItem item={item as Photo} index={index} album={album} />
            )}
          />
        </div>
      )}
