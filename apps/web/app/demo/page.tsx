...
const mockCategories = [
  ...
  { id: '8', name: 'Sport', slug: 'sport', isHidden: false, showInMenu: true },
];

export default function DemoPage() {
  const [selectedCategory, setSelectedCategory] = useState('');
  const [selectedCategoryWithError, setSelectedCategoryWithError] =
    useState('');
