...
import SelectCombobox, { type SelectOption } from '../../components/ui/select-combobox';
...
export default function TestSelectPage() {
  ...
  return (
    <div className="container mx-auto p-8">
      <h1 className="text-3xl font-bold mb-8">Тест универсального Select компонента</h1>
      ...
      <div className="mt-8 p-4 bg-gray-50 rounded-lg max-w-4xl">
        <h3 className="text-lg font-semibold text-gray-900 mb-3">Обрані значення:</h3>
