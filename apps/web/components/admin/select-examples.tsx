...
export default function SelectExamples({ categories, albums }: SelectExamplesProps) {
  ...
  return (
    <div className="space-y-6 p-6 bg-white rounded-lg shadow">
      <h2 className="text-2xl font-bold text-foreground">Select Components Usage Examples</h2>
      ...
      <div className="mt-8 p-4 bg-gray-50 rounded-lg">
        <h3 className="text-lg font-semibold text-foreground mb-3">Selected values:</h3>
